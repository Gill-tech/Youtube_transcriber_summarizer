...
# URL entry
    ...
    st.write("Click the button below to generate blog contents of the video")
    if st.button("Generate Blog Contents"):
        ...
        if youtube_url is None or youtube_url.strip() == "":
            ...
            if youtube_id is None or youtube_id.strip() == "":
                ...
                if transcript == "Error":
                    ...
                    with st.spinner("Getting the contents..."):
                        # get the summary based on the transcript
                        try:
                            summary = create_contents(transcript)
